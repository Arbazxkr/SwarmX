...
export { WhatsAppChannel, type WhatsAppConfig } from "./whatsapp.js";
...
export { GoogleChatChannel, type GoogleChatConfig } from "./googlechat.js";
export { TeamsChannel, type TeamsConfig } from "./teams.js";
